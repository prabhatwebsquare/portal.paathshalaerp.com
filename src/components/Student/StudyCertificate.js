...
const StudyCertificate = ({
  ...
  const handlePrint = useReactToPrint({
    ...
    documentTitle: `Study_Certificate_${student?.studentName || "Student"}`,
    pageStyle: `
      @page {
        size: A4;
        margin: 15mm;
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <strong>{student?.address || "N/A"}</strong>, is a regular
                ...
                <Text
                  ...
                  className="body-text"
                >
                  {student?.gender === "Male" ? "He" : "She"} has been studying
                  in Class <strong>{className}</strong> - Section{" "}
                  <strong>{sectionName}</strong> during the academic session{" "}
                ...
                <Text
                  ...
                  className="body-text"
                >
                  {student?.gender === "Male" ? "His" : "Her"} Date of Birth, as
                  per school records, is <strong>{dob}</strong>.
                </Text>
                ...
                <Text
                  ...
                  className="body-text"
                >
                  This certificate is issued upon request for any purpose it may
                  serve.
                </Text>
