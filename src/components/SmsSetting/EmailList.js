...
export const EmailList = ({ themeColor }) => {
    ...
    return (
        <Box pos={"relative"} h={"70vh"}>
            ...
            {toggleDrawer && <AddEmailSetting data={toggleDrawer} school={school} themeColor={themeColor} closeDrawer={() => setToggleDrawer(null)} />}
        </Box>
    )
}