...
const receiptLayouts = [
    {
        id: 1,
        src: "../assets/marksheet1.png",
        name: "Modern Report",
        selectedId: 1
    },
    {
        id: 2,
        src: "../assets/marksheet2.png",
        name: "Without Total Marks",
        selectedId: 2
    },
];


export const MarksheetLayout = ({ themeColor, Data, closeModal }) => {
    const marksheetLayout = getLocalStorageItem("marksheetLayout")
    const [selectedLayout, setSelectedLayout] = useState(marksheetLayout);
            ...
            >
                ...
                <ModalFooter>
                    <Flex align="center" gap={4} mt={10} w="full" justifyContent="center">
                        ...
                        <Button
                            onClick={() => {
                                setLocalStorageItem("marksheetLayout", selectedLayout);
                                closeModal();
                            }
                            }
                            size="lg"
