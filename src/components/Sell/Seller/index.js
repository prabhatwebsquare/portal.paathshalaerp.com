...
import { AddSupplier, AddVendor } from "./AddSeller";
import { HasPermission } from "@/common/HasPermission";
import { PERMISSIONS } from "@/constant/PermissionConstant";

export const Seller = ({ themeColor }) => {
    ...
    return (
        <Box h={"100%"}>
            <PageHeader heading={"Seller List"} extra={<Button size={"sm"} colorScheme={themeColor} leftIcon={<AddIcon />} onClick={() => setToggleDrawer([])}>Add Seller</Button>} />
