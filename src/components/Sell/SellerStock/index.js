...
export const SellerStock = ({ themeColor, sessionMasterId }) => {
    ...
    return (
        <Box>
            <PageHeader heading={"Seller Stock Report"} extra={<Button size={"sm"} colorScheme={themeColor} onClick={handleAllPrint}>Print</Button>} />
